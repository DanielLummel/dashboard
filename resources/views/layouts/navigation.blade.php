<nav x-data="{ open: false }" class="border-b border-slate-200 bg-white/90 dark:border-slate-700 dark:bg-slate-900/90">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center rounded-md border border-transparent bg-white px-3 py-2 text-sm font-medium leading-4 text-slate-600 transition duration-150 ease-in-out hover:text-slate-800 focus:outline-none dark:bg-slate-900 dark:text-slate-300 dark:hover:text-slate-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="border-t border-slate-200 pt-4 pb-1 dark:border-slate-700">
            <div class="px-4">
